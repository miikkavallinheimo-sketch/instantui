...
> = {
  luxury: {
    ...
    minSatBackground: 20,
    primaryLightRange: [20, 35],
    secondaryLightRange: [42, 58],
    backgroundLightRange: [12, 24],
    accentLightRange: [45, 68],
  },
  "modern-saas": {
    hueJitter: 18,
    satJitter: 14,
  ...
  "dark-tech": {
    ...
    secondaryLightRange: [40, 60],
    backgroundLightRange: [6, 16],
    accentLightRange: [50, 75],
  },
  brutalist: {
    hueJitter: 4,
    satJitter: 8,
    ...
    minSatAccent: 70,
    minSatBackground: 8,
    primaryLightRange: [10, 20],
    secondaryLightRange: [35, 50],
    accentLightRange: [50, 75],
    pairMaxHueDelta: 0,
  ...
  pastel: {
    ...
    minSatSecondary: 20,
    minSatAccent: 35,
    primaryLightRange: [70, 85],
    secondaryLightRange: [70, 85],
    accentLightRange: [65, 80],
    blendStrength: 0.35,
    trendBias: 0.2,
  },
  minimal: {
  ...
  "cyber-mint": {
    ...
    minSatBackground: 25,
    primaryLightRange: [50, 65],
    secondaryLightRange: [50, 70],
    accentLightRange: [60, 85],
    backgroundLightRange: [8, 16],
    pairMaxHueDelta: 45,
    accentMinHueDelta: 70,
    blendStrength: 0.2,
    trendBias: 0.1,
  ...
  "magazine-brutalism": {
    ...
    minSatAccent: 70,
    minSatBackground: 6,
    primaryLightRange: [5, 15],
    secondaryLightRange: [30, 50],
    accentLightRange: [50, 70],
    pairMaxHueDelta: 0,
    accentMinHueDelta: 90,
    backgroundAnchor: 0.95,
    blendStrength: 0.05,
    trendBias: 0.0,
  },
};
