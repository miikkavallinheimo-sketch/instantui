...
> = {
  ...
  dark: {
    ...
    accentBlend: 0.92,
    trendBias: 0,
    backgroundTrendBias: 0,
    backgroundTint: 0,
    backgroundShade: 0,
    surfaceTintRange: 0.04,
    pairMaxHueDelta: 15,
    accentMinHueDelta: 130,
    minSatPrimary: 30,
    minSatSecondary: 20,
    minSatAccent: 85,
    minSatBackground: 0,
    backgroundAnchor: 1,
    backgroundLightRange: [0, 6],
    primaryLightRange: [18, 32],
    secondaryLightRange: [20, 35],
    accentLightRange: [48, 72],
  },
};
